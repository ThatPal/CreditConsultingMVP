...
| D1316-34 | P1 | The exact-head Linux CI exposed retained BullMQ work from another integration proof delaying the business-command pipeline beyond its bounded timeout. | Make queue identity injectable while retaining the production default; use per-suite queue names for isolation and the same name across restart-recovery steps. |

All D1316-29 through D1316-34 corrections are implemented and proven. No other P0/P1 was found. Cosmetic P2/P3 work remains outside this checkpoint correction wave.
