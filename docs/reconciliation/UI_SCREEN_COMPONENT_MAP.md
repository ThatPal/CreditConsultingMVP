...
| -------------------------------------------------- | -------------------------------- | -------------------------------------------------------------- | ------------------ | ---- |
| /                                                  | Navigate                         | Public acquisition root (currently intake redirect)            | REBUILD            | U9   |
...
| /lead-wizard                                       | Navigate                         | Compatibility redirect; validate destination before retirement | KEEP               | U9   |
...
| /dev/design-system                                 | DesignSystemPage                 | Development-only evidence                                      | RESTYLE            | U1   |
| /dev/shell/:role                                   | ShellEvidencePage                | Development-only evidence                                      | RESTYLE            | U1   |
...
| /app/*                                             | FoundationPage                   | Contextual not-found state                                     | RESTYLE            | U1   |
...
| /crm/clients/:clientId/plan                        | ConsultantPlanBuilderPage        | CRM-12                                                         | RECOMPOSE          | U4   |
...
| /crm/*                                             | FoundationPage                   | Contextual not-found state                                     | RESTYLE            | U1   |
...
| /admin/*                                           | FoundationPage                   | Contextual not-found state                                     | RESTYLE            | U1   |
| /client                                            | Navigate                         | Compatibility redirect; validate destination before retirement | KEEP               | U9   |
| /client/overview                                   | Navigate                         | Compatibility redirect; validate destination before retirement | KEEP               | U9   |
| /client/credit-profile                             | Navigate                         | Compatibility redirect; validate destination before retirement | KEEP               | U9   |
| /client/account                                    | Navigate                         | Compatibility redirect; validate destination before retirement | KEEP               | U9   |
| /consultant                                        | Navigate                         | Compatibility redirect; validate destination before retirement | KEEP               | U9   |
| /consultant/dashboard                              | Navigate                         | Compatibility redirect; validate destination before retirement | KEEP               | U9   |
| /consultant/account                                | Navigate                         | Compatibility redirect; validate destination before retirement | KEEP               | U9   |
| /*                                                 | Navigate                         | Compatibility redirect; validate destination before retirement | KEEP               | U9   |
