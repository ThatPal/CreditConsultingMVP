...
- Read `docs/astra/README.md`, `docs/astra/ROADMAP.md`, and `docs/astra/WORKSPACE.md` before continuing. Audit and roadmap are the initial deliverable; product implementation requires the user's subsequent instruction to start.
